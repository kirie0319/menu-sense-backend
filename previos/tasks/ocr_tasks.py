...
def ocr_with_gemini(self, image_path: str, session_id: str = None):
    ...
    try:
        ...
        result = await_sync(google_provider.extract_text_gemini(image_path, session_id))
...
def ocr_with_google_vision(self, image_path: str, session_id: str = None):
    ...
    try:
        ...
        if not google_provider.is_vision_available():
        ...
        result = await_sync(google_provider.extract_text(image_path, session_id))
