...
class S3StorageService:
    ...
    def __init__(self):
        ...
        self.image_prefix = aws_settings.s3_image_prefix
        self.s3_client = None
    ...
    def is_available(self) -> bool:
        """S3サービスが利用可能かチェック"""
        if not aws_settings.use_s3_storage:
            return False
    ...
    def upload_image(
        ...
        try:
            ...
            # パブリックURLを生成
            public_url = aws_settings.s3_public_url_template.format(
                bucket=self.bucket_name,
                region=self.region,
                key=s3_key
            )
    ...
    def get_bucket_info(self) -> dict:
        ...
        return {
            ...
            "use_s3_storage": aws_settings.use_s3_storage
        }
